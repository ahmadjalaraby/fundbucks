...
<head>
    ...
    <meta name="description" content="Fundbucks Login">
    <meta name="author" content="Fundbucks">
    <meta name="keywords" content="nobleui, bootstrap, bootstrap 5, bootstrap5, admin, dashboard, template, responsive, css, sass, html, theme, front-end, ui kit, web">

    <title>Fundbucks - تسجيل الدخول</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    <a href="#" class="noble-ui-logo d-block mb-2">Fund<span>bucks</span></a>
                                    <h5 class="text-muted fw-normal mb-4">مرحبًا بعودتك! تسجيل الدخول إلى حسابك.</h5>
                                    <form class="forms-sample" method="post" action="{{ route('login')  }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control" id="password" name="password" autocomplete="current-password" placeholder="كلمة المرور" required>
                                        ...
                                        <div>
                                            <button type="submit" class="btn btn-primary me-2 mb-2 mb-md-0 text-white">تسجيل الدخول</button>
{{--                                            <button type="button" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">--}}
{{--                                                <i class="btn-icon-prepend" data-feather="twitter"></i>--}}
{{--                                                Login with twitter--}}
{{--                                            </button>--}}
                                        </div>
                                        <a href="#" class="d-block mt-3 text-muted">هل نسيت كلمة المرور؟</a>
                                        @if ($errors->any())
