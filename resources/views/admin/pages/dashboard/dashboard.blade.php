...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">مرحباً بك في لوحة التحكم</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <div class="input-group flatpickr wd-200 me-2 mb-2 mb-md-0" id="dashboardDate">
                        <span class="input-group-text input-group-addon bg-transparent border-primary" data-toggle><i
                                data-feather="calendar" class="text-primary"></i></span>
                <input type="text" class="form-control bg-transparent border-primary" placeholder="اختار تاريخ"
                       data-input>
            </div>
            ...
            <div class="row flex-grow-1">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">المستخدمين الجدد</h6>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item d-flex align-items-center"
                                           href="javascript:;"><i data-feather="download"
                                                                  class="icon-sm me-2"></i> <span class="">تنزيل</span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">الاستثمارات الجديدة</h6>
                                <div class="dropdown mb-2">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">الودائع</h6>
                                <div class="dropdown mb-2">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                        data-feather="eye" class="icon-sm me-2"></i> <span class="">عرض</span></a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                        ...
                                        class="">طباعة</span></a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i
                                        data-feather="download" class="icon-sm me-2"></i> <span class="">تنزيل</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-start">
                        <div class="col-md-7">
                            <p class="text-muted tx-13 mb-3 mb-md-0">قيمة الودائع الإجمالية التي تمت قبولها والتي لم يتم قبولها بعد ولكن من غير التي تم رفضها</p>
                        </div>
                        <div class="col-md-5 d-flex justify-content-md-end">
                            <div class="btn-group mb-3 mb-md-0" role="group" aria-label="Basic example">
                                <button type="button" class="btn btn-outline-primary">يومي</button>
                                <button type="button" class="btn btn-outline-primary d-none d-md-block">أسبوعي
                                </button>
                                <button type="button" class="btn btn-primary">شهري</button>
                                <button type="button" class="btn btn-outline-primary">سنوي</button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-5 col-xl-4 grid-margin grid-margin-xl-0 stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        <h6 class="card-title mb-0">بطاقات الدعم</h6>
                        <div class="dropdown mb-2">
                        ...
                        <a href="javascript:;" class="d-flex align-items-center border-bottom pb-3">
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                                    <h6 class="text-body mb-2">أحمد أحمد</h6>
                                    <p class="text-muted tx-12">12.30 PM</p>
                                </div>
                                <p class="text-muted tx-13">واجهتني مشكلة ما...</p>
                            </div>
                        </a>
        ...
        <div class="col-lg-7 col-xl-8 stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        <h6 class="card-title mb-0">إخطارات الإيداع</h6>
                        <div class="dropdown mb-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tr>
                                <th class="pt-0">#</th>
                                <th class="pt-0">اسم المستخدم</th>
                                <th class="pt-0">تاريخ الإيداع</th>
                                <th class="pt-0">المبلغ</th>
                                <th class="pt-0">الحالة</th>
                                <th class="pt-0">ملاحظات</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td>01/01/2022</td>
                                <td>300.0$</td>
                                <td><span class="badge bg-danger">ناجح</span></td>
                                <td>تجربة تجربة تجربة...</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>أحمد أحمد</td>
                                <td>01/01/2022</td>
                                <td>300.0$</td>
                                <td><span class="badge bg-success">معلق</span></td>
                                <td>تجربة تجربة تجربة...</td>
                            </tr>
                            <tr>
                                <td>3</td>
                            ...
                            <tr>
                                ...
                                <td>01/01/2022</td>
                                <td>300.0$</td>
                                <td><span class="badge bg-warning">معلق</span>
                                </td>
                                <td>تجربة تجربة تجربة...</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>01/01/2022</td>
                                <td>300.0$</td>
                                <td><span class="badge bg-primary">ناجح</span></td>
                                <td>تجربة تجربة تجربة...</td>
                            </tr>
                            <tr>
                                <td class="border-bottom">3</td>
                                <td class="border-bottom">أحمد أحمد</td>
                                <td class="border-bottom">01/05/2022</td>
                                <td class="border-bottom">300.0$</td>
                                <td class="border-bottom"><span class="badge bg-info">معلق</span></td>
                                <td class="border-bottom">تجربة تجربة تجربة...</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
